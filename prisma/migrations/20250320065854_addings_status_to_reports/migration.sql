...
INSERT INTO "new_Report" ("createdAt", "id", "repoContextId", "repoTreeId", "repoUrl", "updatedAt", "userId") SELECT "createdAt", "id", "repoContextId", "repoTreeId", "repoUrl", "updatedAt", "userId" FROM "Report";
DROP TABLE "Report";
